...
class CustomUrl extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CustomUrlState();
}
...
class _CustomUrlState extends State<CustomUrl> {
  ...
  AppBar? get appBar {
    ...
    return AppBar(
      title: const Text("Custom URL Launcher"),
    );
  }
            ...
            ButtonTheme(
              ...
              child: OutlinedButton(
                onPressed: () async {
                  ...
                  StartupConfiguration customUrlStartupConfiguration = StartupConfiguration();
                  ...
                  Sample sample = Sample(requiredExtensions: [], name: "Custom URL", path: customWorldUrlText.text, requiredFeatures: customUrlRequiredFeatures, startupConfiguration: customUrlStartupConfiguration);
